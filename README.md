...
- Files created by assistant tools (`create_file`, `artifacts`) extracted to `created/`
...
├── attachments/
│   └── <chat-uuid>/<filename>     # files YOU sent in
└── created/
    └── <chat-uuid>/<filename>     # files Claude created via tools
```
